...
?>
		...
		<div id="fh5co-team-section">
			<div class="container">
				<div class="row">
					<h2>ENCUESTA INNOVA</h2>
					<div class="alert alert-info"><h3>Importante</h3><p>Para poder participar es necesario ingresar con una cuenta de innova , de no contar con una cuenta regístrese, saludos y mucha suerte.</p></div>
