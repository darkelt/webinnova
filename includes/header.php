						          ...
						          <a  class="fh5co-sub-ddown user-icons" href=<?php if ($_SESSION['permiso'] == 'A'){
												...
												?>><?php if (isset($_SESSION['username'])){
																											       ...
																											       if (!$_SESSION['url_picture']==NULL){
																											       		echo "<img src='".htmlentities($_SESSION['url_picture'])."' style='position: absolute; top: 7; left: -15;'class='img-circle' alt='facebook' width='50' height='50'>"; 
																											       }else{
									...
									<ul id="login-dp" >
										<li><a href="../includes/perfil.php"><?php if (isset($_SESSION['username'])){
