						...
						<div class="col-md-4">
							...
							<ul class="contact-info">
								<li><i class="icon-map2"></i>Arequipa - Perú<br />
									Calle Juana Espinoza 300 - Etapa  1<br />
									Urbanización Magisterial, Umacollo.</li>
						...
						<div class="col-md-4">
							...
							<form class="contact-form" method="post"  action="sendbymail.php">
								<div class="form-group">
									...
									<input type="name" class="form-control" id="name" placeholder="Name" readonly="yes" value="<?php echo htmlentities($_SESSION['username']);?>" required>
								</div>
								<div class="form-group">
									<label for="comments" class="sr-only">Mensaje</label>
									<textarea class="form-control" name="comments" id="message" rows="7" placeholder="Message"  required></textarea>
								</div>
								<div class="form-group">
