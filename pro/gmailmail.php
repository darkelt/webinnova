...
function correoConfirmacion($idgrupo, $email_user, $xnomcomple, $xuser , $xcurso, $pagom, $pagom_dolar, $xmoda, $xfini , $xlocal , $iddes){
                                ...
                                <tbody>
                                  ...
                                  <tr style="height: 43px;">
                                    <td style="width: 50%; height: 43px;" colspan="2">
                                      ...
                                      <i><strong style="font-size: 8pt;">Para acceder a nuestro Campus Virtual, haz click aqui:</strong></i>
                                      <p> <a href="https://www.innovatrainingperu.com/campusinnova/login.php" target="_blank"><img src="http://innovatrainingperu.com/images/mailimg/OP/botoncampus.jpg" alt="boton campus innova" style="display: block; margin-left: auto; margin-right: auto;" /></a></p>
                                      <ul>
                                  ...
                                  <tr style="height: 43px;">
                                    <td style="width: 50%; height: 43px; font-size: 7pt;" colspan="2">
                                      <p><i>* Recuerda.!!. tu contraseña es la misma para nuestro campus y todos los cursos en los que te encuentras inscrito.</i><br>
                                      <i>** Si ya estas inscrito en nuestro campus virtual y cambiaste tu contraseña omite esta contraseña, recuerda que puedes recuperar tu contraseña desde el login.<br />¡Que tengas un excelente curso!. </i>
                                      </p>
                                    </td>
                                  </tr>
                                </tbody>
                                  ...
                                  <tr style="height: 43px;">
                                    <td style="width: 50%; height: 43px;" colspan="2">
                                      ...
                                      <ul>
                                        ...
                                        <li><strong style="font-size: 8pt;">Horario: </strong></li>
