				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
							...
							<?php
								...
								for($x = 0; $x < $arrlength; $x++) {
									 ...
									 $total_dolar[$x]= $xprecio_dolar_array[$x] - ($factor_pack*$xprecio_dolar_array[$x]);
				   				    $pagom_dolar_array[$x]= number_format( $total_dolar[$x], 2, '.', '');

									$total[$x]= $xprecio_array[$x] -($factor_pack*$xprecio_array[$x]);
									$pagom_array[$x]=number_format($total[$x], 2, '.', '');
									
									$resultado=$resultado + $total[$x]; 	
									$resultado_dolar = $resultado_dolar + $total_dolar[$x]; 
								}	
											...
											<div class="form-group">
												...
												<div class="form-group">
												    <label  class="col-md-4 control-label">Localidad: </label>
												   	...
												   	<?php 
												   			if($ciudad == "MEXICO-CHIAPAS"){
																echo'<label class="radio-inline col-md-5" value="local"><input type="radio" name="xlocal"  value="nolocal" onclick="if(this.checked){myFunction1()}" checked  required>$ciudad</label>';

												   			}else{

												   				echo'<label class="radio-inline col-md-5" value="local"><input type="radio" name="xlocal"  value="local" onclick="if(this.checked){myFunction1()}" checked  required>'.$ciudad.'</label>';
												...
												<input type="hidden" name="horario" value="Horario pack">
												<!--
												<div class="form-group">
								    ...
								    <div class="col-md-12">
								    	<ol>
													<li>Realizar Pre-Matricula.</li>
													 	<?php 
												   			if($ciudad == "MEXICO-CHIAPAS"){
																echo'<li>Depositar Wester Union , Pagos Paypal, Visanet (Solicitar link cursos@innovatrainingperu.com)</li>';

												   			}else{

												   				echo'<li>Depositar en el Banco BCP - Cuenta Corriente 215-2269160-0-24 (deposito, transferencia, agente BCP)</li>';
					...
					<script>
						function myFunction() {
							...
							document.getElementById("demo").innerHTML = "S/. " + precio +" - " +  "$. " + precio_dolar;
