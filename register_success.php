					...
					<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
							<div class="row">
								<div class="col-md-12">
									...
									<P>Ahora puedes ingresar a pre-matricularte en nuestros cursos.</P>
									<div>
										<a class="btn btn-block btn-social btn-facebook" onclick="_gaq.push(['_trackEvent', 'btn-social', 'click', 'btn-facebook']);" style="font: 98% Sans-serif; color:white" >
